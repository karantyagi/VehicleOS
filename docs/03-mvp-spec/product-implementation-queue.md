...
| MOBILE-CAP-1 | P1 | Implemented | Specify the capture-only mobile flow | Vehicle target, photo/PDF, text-first service note with optional browser dictation, upload progress, retry, connection-aware save boundary, and explicit success/completion are covered |
