...
| **Surfaces** | Web app (live) · mobile · Vehicle OS Connect desktop (planned) |
...
- **Reminder:** what needs attention, when, and why now.
...
reminder model. Action recommendations never change the underlying due rule.
